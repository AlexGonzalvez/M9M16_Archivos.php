...
<html lang="es">
    <head>
        <title>Formulario de eliminación de un libro </title>
    </head>
    <body>
 	...
 	*/
        ...
        $id = $_GET["id"];
        $consulta_eliminacion = "DELETE FROM libros WHERE libro_id = $id";
        ...
        if (!mysqli_query($conn, $consulta_eliminacion)) {
            ...
            <h1>Eliminacion realizada con éxito! <a href = "listado_libros.php">Volver al listado de libros</a></h1>
